...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    if(uLineStyle>0.5){
        ...
        if(uLineStyle<1.5){lineX*=dashMaskY;lineY*=dashMaskX;}
            ...
            float cy2=abs(fract(gridUV.y*dotRepeat)-0.5);
            float cx2=abs(fract(gridUV.x*dotRepeat)-0.5);
            float dotMaskY=1.0-smoothstep(dotWidth,dotWidth+fwidth(gridUV.y*dotRepeat),cy2);
    ...
    if(uLineStyle>0.5){
        ...
        if(uLineStyle<1.5){lineX2*=dashMaskY2;lineY2*=dashMaskX2;}
            ...
            float cy3=abs(fract(gridUV2.y*dotRepeat2)-0.5);
            float cx3=abs(fract(gridUV2.x*dotRepeat2)-0.5);
            float dotMaskY2=1.0-smoothstep(dotWidth2,dotWidth2+fwidth(gridUV2.y*dotRepeat2),cy3);
            float dotMaskX2=1.0-smoothstep(dotWidth2,dotWidth2+fwidth(gridUV2.x*dotRepeat2),cx3);
