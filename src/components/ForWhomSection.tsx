...
const suitable = [
  "HR с опытом от 1 года",
  "Есть рабочий контекст для внедрения",
  "Готовы выполнять задания и внедрять",
  "Хотите расти до уровня HRBP",
];

const notSuitable = [
  "Без опыта в HR",
  "Хотите только теорию",
  "Нет реального контекста для внедрения",
  "Нет мотивации расти",
];
